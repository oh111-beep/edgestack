    ...
    return(
        <main className="bg-gray-100 shadow-gray-300 w-full">
            <div className="h-15 flex justify-between items-center px-5">
                <h1 className="text-3xl font-blod text-blue-500">EdgeStack</h1>
            ...
            <div className="flex flex-col gap-2 justify-center items-center">
                ...
                <Link href="/auth/login">
                <div className="w-20 h-10 rounded md:shadow md:text-white md:flex md:justify-center items-center bg-blue-500">
                    <p>Sign Up</p>
                </div>
                </Link>
            </div>
